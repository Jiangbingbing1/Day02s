...
public class RxxpAdapter extends RecyclerView.Adapter<RxxpAdapter.Hander> {

    private List<UserBean.ResultBean.RxxpBean.CommodityListBean> list;
    private Context context;

    public RxxpAdapter(List<UserBean.ResultBean.RxxpBean.CommodityListBean> list, Context context) {
        this.list = list;
